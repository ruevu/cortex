...
static const CtxLangSpec lang_specs[CTX_LANG_COUNT] = {
    ...
    // CTX_LANG_PYTHON
    {CTX_LANG_PYTHON, py_func_types, py_class_types, empty_types, py_module_types, py_call_types,
    ...
    // CTX_LANG_JAVASCRIPT
    {CTX_LANG_JAVASCRIPT, js_func_types, js_class_types, empty_types, js_module_types,
    ...
    // CTX_LANG_TYPESCRIPT
    {CTX_LANG_TYPESCRIPT, ts_func_types, ts_class_types, empty_types, js_module_types,
     js_call_types, js_import_types, js_import_types, js_branch_types, js_var_types,
     (const char *[]){"assignment_expression", "augmented_assignment_expression", NULL},
     js_throw_types, NULL, ts_decorator_types, NULL, ts_env_members},

    // CTX_LANG_TSX
    {CTX_LANG_TSX, ts_func_types, ts_class_types, empty_types, js_module_types, js_call_types,
     js_import_types, js_import_types, js_branch_types, js_var_types,
     (const char *[]){"assignment_expression", "augmented_assignment_expression", NULL},
     js_throw_types, NULL, ts_decorator_types, NULL, ts_env_members},

    // CTX_LANG_RUST
    {CTX_LANG_RUST, rust_func_types, rust_class_types, rust_field_types, rust_module_types,
    ...
    // CTX_LANG_JAVA
    {CTX_LANG_JAVA, java_func_types, java_class_types, java_field_types, java_module_types,
    ...
    // CTX_LANG_CPP
    {CTX_LANG_CPP, cpp_func_types, cpp_class_types, cpp_field_types, cpp_module_types,
    ...
    // CTX_LANG_CSHARP
    {CTX_LANG_CSHARP, cs_func_types, cs_class_types, empty_types, cs_module_types, cs_call_types,
    ...
    // CTX_LANG_PHP
    {CTX_LANG_PHP, php_func_types, php_class_types, empty_types, php_module_types, php_call_types,
    ...
    // CTX_LANG_LUA
    {CTX_LANG_LUA, lua_func_types, empty_types, empty_types, lua_module_types, lua_call_types,
    ...
    // CTX_LANG_SCALA
    {CTX_LANG_SCALA, scala_func_types, scala_class_types, empty_types, scala_module_types,
    ...
    // CTX_LANG_KOTLIN
    {CTX_LANG_KOTLIN, kotlin_func_types, kotlin_class_types, empty_types, kotlin_module_types,
    ...
    // CTX_LANG_RUBY
    {CTX_LANG_RUBY, ruby_func_types, ruby_class_types, empty_types, ruby_module_types,
    ...
    // CTX_LANG_C
    {CTX_LANG_C, c_func_types, c_class_types, c_field_types, c_module_types, c_call_types,
     c_import_types, empty_types, c_branch_types, c_var_types, c_assign_types, empty_types, NULL,
     empty_types, c_env_funcs, NULL},

    // CTX_LANG_BASH
    {CTX_LANG_BASH, bash_func_types, empty_types, empty_types, bash_module_types, bash_call_types,
     bash_import_types, empty_types, bash_branch_types, bash_var_types, bash_var_types, empty_types,
     NULL, empty_types, NULL, NULL},

    // CTX_LANG_ZIG
    {CTX_LANG_ZIG, zig_func_types, zig_class_types, zig_field_types, zig_module_types,
    ...
    // CTX_LANG_ELIXIR
    {CTX_LANG_ELIXIR, elixir_func_types, empty_types, empty_types, elixir_module_types,
    ...
    // CTX_LANG_HASKELL
    {CTX_LANG_HASKELL, haskell_func_types, haskell_class_types, empty_types, haskell_module_types,
    ...
    // CTX_LANG_OCAML
    {CTX_LANG_OCAML, ocaml_func_types, ocaml_class_types, empty_types, ocaml_module_types,
    ...
    // CTX_LANG_OBJC
    {CTX_LANG_OBJC, objc_func_types, objc_class_types, objc_field_types, objc_module_types,
    ...
    // CTX_LANG_SWIFT
    {CTX_LANG_SWIFT, swift_func_types, swift_class_types, swift_field_types, swift_module_types,
    ...
    // CTX_LANG_DART
    {CTX_LANG_DART, dart_func_types, dart_class_types, dart_field_types, dart_module_types,
    ...
    // CTX_LANG_PERL
    {CTX_LANG_PERL, perl_func_types, empty_types, empty_types, perl_module_types, perl_call_types,
    ...
    // CTX_LANG_GROOVY
    {CTX_LANG_GROOVY, groovy_func_types, groovy_class_types, empty_types, groovy_module_types,
    ...
    // CTX_LANG_ERLANG
    {CTX_LANG_ERLANG, erlang_func_types, empty_types, empty_types, erlang_module_types,
    ...
    // CTX_LANG_JULIA
    {CTX_LANG_JULIA, julia_func_types, julia_class_types, empty_types, julia_module_types,
    ...
    // CTX_LANG_VIMSCRIPT
    {CTX_LANG_VIMSCRIPT, vim_func_types, empty_types, empty_types, vim_module_types, vim_call_types,
     empty_types, empty_types, vim_branch_types, vim_var_types, vim_var_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_NIX
    {CTX_LANG_NIX, nix_func_types, empty_types, empty_types, nix_module_types, nix_call_types,
     empty_types, empty_types, nix_branch_types, nix_var_types, nix_var_types, empty_types, NULL,
     empty_types, nix_env_funcs, NULL},

    // CTX_LANG_COMMONLISP
    {CTX_LANG_COMMONLISP, commonlisp_func_types, empty_types, empty_types, commonlisp_module_types,
     commonlisp_call_types, empty_types, empty_types, empty_types, empty_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CTX_LANG_ELM
    {CTX_LANG_ELM, elm_func_types, elm_class_types, empty_types, elm_module_types, elm_call_types,
     elm_import_types, empty_types, elm_branch_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_FORTRAN
    {CTX_LANG_FORTRAN, fortran_func_types, fortran_class_types, empty_types, fortran_module_types,
    ...
    // CTX_LANG_CUDA (reuses C++ node types)
    {CTX_LANG_CUDA, cpp_func_types, cpp_class_types, cpp_field_types, cpp_module_types,
     cpp_call_types, cpp_import_types, cpp_import_types, cpp_branch_types, cpp_var_types,
     cpp_assign_types, cpp_throw_types, NULL, empty_types, cpp_env_funcs, NULL},

    // CTX_LANG_COBOL
    {CTX_LANG_COBOL, cobol_func_types, empty_types, empty_types, cobol_module_types,
     cobol_call_types, empty_types, empty_types, cobol_branch_types, cobol_var_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CTX_LANG_VERILOG
    {CTX_LANG_VERILOG, verilog_func_types, verilog_class_types, empty_types, verilog_module_types,
    ...
    // CTX_LANG_EMACSLISP
    {CTX_LANG_EMACSLISP, elisp_func_types, empty_types, empty_types, elisp_module_types,
     elisp_call_types, empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
     NULL, empty_types, NULL, NULL},

    // CTX_LANG_JSON
    {CTX_LANG_JSON, empty_types, empty_types, empty_types, json_module_types, empty_types,
     empty_types, empty_types, empty_types, json_var_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_XML
    {CTX_LANG_XML, empty_types, xml_class_types, empty_types, xml_module_types, empty_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_MARKDOWN
    {CTX_LANG_MARKDOWN, empty_types, markdown_class_types, empty_types, markdown_module_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
     NULL, empty_types, NULL, NULL},

    // CTX_LANG_MAKEFILE
    {CTX_LANG_MAKEFILE, makefile_func_types, empty_types, empty_types, makefile_module_types,
    ...
    // CTX_LANG_CMAKE
    {CTX_LANG_CMAKE, empty_types, empty_types, empty_types, cmake_module_types, cmake_call_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_PROTOBUF
    {CTX_LANG_PROTOBUF, empty_types, protobuf_class_types, protobuf_field_types,
    ...
    // CTX_LANG_GRAPHQL
    {CTX_LANG_GRAPHQL, empty_types, graphql_class_types, graphql_field_types, graphql_module_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
     NULL, empty_types, NULL, NULL},

    // CTX_LANG_VUE
    {CTX_LANG_VUE, empty_types, empty_types, empty_types, vue_module_types, empty_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_SVELTE
    {CTX_LANG_SVELTE, empty_types, empty_types, empty_types, svelte_module_types, empty_types,
     empty_types, empty_types, svelte_branch_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_MESON
    {CTX_LANG_MESON, meson_func_types, empty_types, empty_types, meson_module_types,
    ...
    // CTX_LANG_GLSL (reuses C node types)
    {CTX_LANG_GLSL, c_func_types, c_class_types, c_field_types, c_module_types, c_call_types,
     c_import_types, empty_types, c_branch_types, c_var_types, c_assign_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_INI
    {CTX_LANG_INI, empty_types, ini_class_types, empty_types, ini_module_types, empty_types,
     empty_types, empty_types, empty_types, ini_var_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_MATLAB
    {CTX_LANG_MATLAB, matlab_func_types, matlab_class_types, empty_types, matlab_module_types,
    ...
    // CTX_LANG_LEAN
    {CTX_LANG_LEAN, lean_func_types, lean_class_types, empty_types, lean_module_types,
     lean_call_types, lean_import_types, empty_types, lean_branch_types, empty_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CTX_LANG_FORM
    {CTX_LANG_FORM, form_func_types, empty_types, empty_types, form_module_types, form_call_types,
     form_import_types, empty_types, form_branch_types, form_var_types, form_assign_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CTX_LANG_MAGMA
    {CTX_LANG_MAGMA, magma_func_types, empty_types, empty_types, magma_module_types,
    ...
    // CTX_LANG_WOLFRAM
    {CTX_LANG_WOLFRAM, wolfram_func_types, empty_types, empty_types, wolfram_module_types,
     wolfram_call_types, wolfram_import_types, empty_types, empty_types, empty_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CTX_LANG_KUSTOMIZE — reuses YAML grammar; semantic extraction via ctx_extract_k8s()
    {CTX_LANG_KUSTOMIZE, empty_types, empty_types, empty_types, yaml_module_types, empty_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},

    // CTX_LANG_K8S — reuses YAML grammar; semantic extraction via ctx_extract_k8s()
    {CTX_LANG_K8S, empty_types, empty_types, empty_types, yaml_module_types, empty_types,
     empty_types, empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
     empty_types, NULL, NULL},
};
